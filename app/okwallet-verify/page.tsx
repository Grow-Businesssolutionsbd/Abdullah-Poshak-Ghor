...
export default function OkWalletVerifyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex items-center justify-center p-4">
      <div className="w-full max-w-3xl bg-white rounded-xl border border-gray-200 p-6">
        ...
        {/* Top Header */}
        <div className="border border-green-100 rounded-xl px-4 py-5 flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 gap-5 mt-10">
          ...
          <div className="border border-green-100 rounded-xl p-4 flex items-center gap-4">
          ...
          <div className="border border-green-100 rounded-xl flex items-center justify-center">
        ...
        <div className="mt-5 border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="p-5 border-b border-gray-200 flex gap-3">
            ...
            <p className="text-lg">
              আপনার Ok Wallet মোবাইল অ্যাপে যান।
            </p>
          </div>
          ...
          <div className="p-5 border-b border-gray-200 flex gap-3">
            ...
            <p className="text-lg">
              নিশ্চিত করে এখন আপনার Ok Wallet পিন লিখুন।
            </p>
          </div>
          ...
          <div className="p-5">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-xl px-4 py-4 text-lg outline-none focus:ring-2 focus:ring-green-600"
            />
          </div>
        </div>

        {/* Verify Button */}
        <button className="w-full mt-8 bg-green-600 hover:bg-green-700 text-white text-2xl font-bold py-5 rounded-xl transition">
          VERIFY
        </button>
      </div>
    </div>
